---
title: Tarran Architecture
tags: [architecture, taran, firethorn-empire, magic-system, eadras]
...
## Three traditions, strictly separated

The defining structural fact of Tarran architecture is its **strict functional separation**. The Tarran built three different kinds of buildings in three different styles, and they did not mix the styles. A military fortress did not look like a temple. A temple did not look like an imperial bureau. An imperial bureau did not look like a fortress. The eye knew, at a glance, what kind of building one was looking at.

This separation was a cultural commitment, not an aesthetic accident. Each tradition was controlled by a different institutional authority, and each authority was extremely jealous of its prerogatives.
...
**The army built fortresses to win wars and not for any other reason.**
...
## 2. Sacred / temple architecture

Where the Tarran allowed themselves to be **artistic and magical**, they channeled the impulse into temple architecture. Sacred buildings were the playground for centuries of competitive design between religious orders, and the diversity is correspondingly broad.

### Common DNA across all orders
...
**Reserved exclusively** for buildings that directly served the central Empire. This includes:

- Bureaucratic offices and ministries
- Military headquarters (the command function, distinct from frontier fortresses)
- Provincial governors' palaces
- Imperial courts of law
- Ceremonial halls of state
- The core administrative buildings within the [[#The Imperial Palace|Imperial Palace]] complex

Imperial architecture **does not appear** in regular city buildings, in sacred temples, or in field military fortresses. If one sees the imperial style, the building one is looking at is part of the central Empire's machinery.

### The Roman-Ottoman hybrid
...
- A protective dome of warding visible from outside the building at night (when the empire was at its height, major imperial cities glowed gently with golden-red ward-light long after sundown)
...
The minaret towers are how a visitor (then or now) instantly recognizes an imperial building from a hundred meters off. Domes occur in many architectures. Spell-crystal minarets are uniquely imperial-Tarran.
...
The Palace was vast. Some sources say it spanned several square kilometres at its peak. Records of its full layout survived only in fragments, mostly through Velrathi diplomatic accounts and early Katharim record-priest reports. It is the single building most associated with Firethorn Empire grandeur in modern memory.

The Palace's fate at the end of the Empire is documented elsewhere. Its post-banishment status is part of the [[gray-matriarchy|Gray Matriarchy]] and [[firethorn-hold|Firethorn Hold]] story.

## Why this works

The blend of Roman, Ottoman, Bagan, Javanese, and Khmer-Wat influences sometimes strikes modern observers as eclectic. The internal logic is clear once the functional separation is understood:
...
Tarran ruins are scattered across the post-Cataclysm continents wherever the Firethorn Empire reached, which is nearly everywhere. Most ruined sites belong clearly to one of the three traditions and can be classified at a glance. The classification is one of the more straightforward archaeological exercises on Eadras.
