...
5. The remainder drifted **west** and split into the **two western landmasses** (the northwestern continent of the [[dragon-empire|Dragon Empire]] and [[verdant-scar|Verdant Scar]]; and the southwestern **Dark Continent** behind its ward — the established prison-continent **[[varkhul|Varkhul]]** inside the [[continental-ward|Continental Ward]]; see the [note below](#Marked-coordinates-and-antipodes)).
...
| **[[verdant-scar|Verdant Scar]]** (Arath-Veyr) | 151, 385 | ~22°N | 1177, 640 | **[[amunorians|Sarathis]]** (geographic antipode; the Scar is **not** itself a conduit end — see note) |
| **[[amunorians|Sarathis]]** (tropical southern conduit city) | 1177, 640 | ~22.5°S | 151, 385 | the **[[verdant-scar|Verdant Scar]]** spot (geographic antipode only; Sarathis's conduit Far-Kin is open canon) |
...
- **Verdant Scar / Sarathis.** The forest sits at **(151, 385)**, whose geographic antipode through the core is **(1177, 640), ~22.5°S on southern [[halaran|Halaran]]** — the fallen **[[amunorians|Sarathis]]**, a Crusade-destroyed [[order-sharanel|Tower]] site. But the **Verdant Scar is not one of the fourteen modern conduit ends** (user direction 2026-06-03; the modern never-Tower end is [[ratharil|Ratharil]] — see [[seven-conduits]]). Sarathis remains a conduit-end, but its modern conduit **Far-Kin is open canon**: the two coordinates are exact antipodes by geometry, yet the Scar itself is a ley-vault regulator over ruined Arathi infrastructure, not a terminus of the living cycle. (In the *Arathi era*, Arath-Veyr did stand at a conduit end paired with [[altea|Altea]]; that deep-time pairing is retained.)
