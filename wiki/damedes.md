...
Damedes is one of the **three continents that formed from the sundered [[altean-highlands|Altean Highlands]]** when the [[worldender|Worldbreaker]] struck and ignited plate tectonics. Together with [[avalon|Avalon]] (north) and [[culethor|Culethor]] (southeast), Damedes makes up the Altean-derived continental triad. The fragmentation began at the moment of impact (10mya BP); the named, distinct continent of Damedes stabilized within the first million years (see [[eadras-tectonic-history#1mya post-Cataclysm]]).

Damedes's pre-sundering identity was as the southwestern portion of the Altean Highlands. Specific pre-Cataclysm features that mapped onto Damedes's modern footprint are undefined.
...
This is a stub. Damedes currently exists in canon as a named landmass at four geological snapshots; specific surface features are visible on the maps but not yet described in text.

- **Modern descendant continent**: which present-day landmass descends from Damedes's post-Eldravath fracture is undefined. [[varkhul|Varkhul]] is the modern continent in the same general position, but the lineage relationship has not been confirmed.
