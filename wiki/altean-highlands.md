---
title: Altean Highlands
tags: [geographic-feature, eadras, arathi, extinct]
...
**Summary**: The Altean Highlands were a continent-sized upland that dominated pre-Cataclysm Eadras and held [[altea|Altea]] at its center; the [[worldender|Worldbreaker]] impact and the [[arathi-cataclysm|Cataclysm]] sundered the Highlands into three continents separated by the [[arathalassic-sea|Arathalassic Sea]].

**Sources**: Major changes to Arathi Capitol.txt, Arathis.txt, map explanation.txt
...
When the [[worldender|Worldbreaker]] struck Altea, the impact and the subsequent unzipping of the planetary crust split the Altean Highlands into **three continents** that drifted apart as plate tectonics initiated. The cavity between them flooded with the superheated waters of the White Deluge and became the [[arathalassic-sea|Arathalassic Sea]] (source: Major changes to Arathi Capitol.txt).
...
In the present:
- The three sundered continents bear most of Eadras's surviving Arathi-era ruins (rare, fragmentary).
- The Arathalassic Sea fills the cavity between them.
- The [[arathyn]] formed by the Worldbreaker's Large Igneous Province now occupies the impact center, where Altea once stood.

The Altean Highlands as a single feature no longer exist. The phrase survives only as a historical / scholarly term for the lost pre-Cataclysm landmass.
