...
aliases: [Little Gods, the Little Gods]
---
...
## How Netharim magic works

The Netharim do not speak any of the [[true-language|reality-structuring languages]]. They are not [[lexanari|Lexanari]] reaching for the Primordial tier; they are not [[priests|priests]] borrowing the Divine voice; they are not [[wizards|wizards]] building structured Arcane formulas. They simply **understand reality**, and from that understanding they exert direct intuitive influence on the world around them.

The mechanism is consistent across every Netharim, but the **expression** depends entirely on the practitioner's personal model.

A Netharim who wishes to start a fire might do any of the following:

- A Netharim with no particular knowledge of physics will simply imagine a small spark forming above some dry tinder. A spark forms.
- A Netharim who understands ignition will draw all the **light** in the immediate vicinity into a single point above the tinder, and the concentration will combust the material spontaneously.
- A Netharim who understands thermodynamics will pull the **heat** out of the surrounding air and concentrate it as a single point, igniting the tinder while leaving the area around them noticeably colder.
- A Netharim who understands chemical kinetics will accelerate the surface oxidation of the material directly into rapid combustion.

Each of these is a real Netharim working a real fire. The fires look identical to anyone watching from outside. To the Netharim, they are *very different acts*, because the internal model that produced them is different in each case.

This produces the central principle of Netharim practice:

> *Magic is the imposition of comprehension on reality. The clearer and more accurate your comprehension, the more precise the imposition.*

## The lifelong study

Because Netharim magic scales with the accuracy and completeness of the practitioner's internal model of reality, **most Netharim spend the majority of their lives studying**.
...
## Distinction from the old Netharim tradition

The Netharim fill the niche the old [[order-sharanel|Netharim]] tradition used to occupy as *"intuitive practitioners who manipulate reality directly without book-formulas."* They are not, however, mechanically the same. The previous canonical Netharim drew structured threads from the [[magic-in-eadras|Weave]] and tied them into spell-knots; the Netharim do not interact with the Weave at any structural level and do not produce knot-spells. The mapping from the old Netharim tradition to the Netharim is conceptual, not mechanical. See [[log]] and [[inspirations]] for the rework history.

## Open canon

- The order's actual name in its own internal usage. *Netharim* is established; whether the order's members refer to themselves more often as Netharim, *Little Gods*, *The Order*, *Scholars of the World*, or some entirely different working term is open.
- Whether the order has a single supreme leadership council, a federation of regional houses, or some other structure. The "worldwide" framing is canonical; the precise governance is not.
- The order's relationship to the [[order-sharanel|Order Sharanel]] under the new canon. Under the old canon they would have been distinct. Under the new canon their institutional relationship is open: the same bodies could be merging, separating, or coexisting in the same Towers of Lirra in tense parallel.
- The full list of Netharim study traditions and which ones produce which kinds of practitioners. The list provided above is illustrative, not exhaustive.
