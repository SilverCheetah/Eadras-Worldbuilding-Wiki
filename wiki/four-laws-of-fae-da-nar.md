---
title: The Four Laws of Fae-da'Nar
tags: [doctrine, eadras, fae]
aliases: [Four Laws, Four Laws of Fae-da'Nar, Faedanar laws]
...
**Forbids**: rampages, predation, brutality, kidnapping, terrorising settlements, unnecessary killing, and behaviour that confirms human monster-fears.
...
**Forbids**: domination of human politics, manipulation of human governance, public attention, glamour-rule, exposure-risking action, reshaping human civilisation from within.

**Core function**: coexistence without domination.

Woodkin living among humans must remain **discreet, avoid political power, avoid manipulation, and avoid public attention**. They may live beside humans, but not reshape human civilisation from within.

The law likely permits:

- Trade, friendship, craft
- Marriage in some cases (interpretation varies by region and species)
- Healing, local service
- Neighbourly participation in everyday community life

The law forbids:

- Becoming mayor through glamour
- Enthralling a magistrate
- Manipulating royal succession
- Capturing a temple
- Turning a human village into a Woodkin feeding pen
- Becoming the mysterious advisor behind seven kings while insisting you are *just helping*

(That last clause has history. The Council declined to name specifics.)

> ***"The Second Law permits nearness. It forbids possession."***

The Second Law also preserves **human sovereignty**, even though that is not its primary purpose. Affecting humans is not controlling them; affecting allows trade and friendship. Controlling provokes the exposure the First Law forbids.
...
**Forbids**: passive tolerance of Shunned predation on humans.

**Core function**: collective reputation management through controlled enforcement.

The [[the-shunned|Shunned]] are races or beings who **prey upon humans and reject Fae-da'Nar law**. They are not merely disliked. They are **outside the compact** entirely.

Fae-da'Nar policy is *not* proactive extermination of the Shunned. Constant hunting creates constant war; constant war creates exposure. And some Shunned are difficult to distinguish from lawful Woodkin until they act.

The Third Law **activates when Shunned threaten humans**. Their predation endangers everyone by provoking human retaliation against all Woodkin, lawful and unlawful alike. Enforcement is not moral purity. It is **containment of reputational catastrophe**.
...
**Forbids**: defiance of Druid judgment, violation of Druid grounds, attack on Druid persons.

**Core function**: neutral diplomatic and judicial framework preventing endless tribal conflict.

The Fourth Law does **not** make [[druids|Druids]] rulers of Fae-da'Nar. It makes them **trusted judges, communicators, healers, mediators, and keepers of neutral ground**.
...
The Druids enforce **thresholds**, not language. They decide:

- When appetite becomes predation
- When secrecy becomes manipulation
- When interference becomes domination
- When Shunned action threatens the compact
- When mercy becomes risk
...
- No warning if already considered too dangerous

The Druids decide the close cases. They determine whether the warning was given, whether the second violation occurred, whether no warning is owed. Theirs is a terrible burden, and judgment-honesty is the load-bearing virtue the role requires.

## What the Laws don't cover

The Laws are **survival thresholds, not moral completeness**. They preserve a hidden society. They do not answer every question of fairness. They do not provide:

- A theory of justice between Woodkin races
- Guidance on intra-species disputes that do not endanger the whole
- Rules for inheritance, marriage, property within Woodkin society
- Mediation for purely fey-internal feuds that do not affect humans

These matters are handled by **local custom, species-specific tradition, fey-court ruling, or Druid mediation** outside the Four Laws. The Laws set the floor that everyone agrees on. Above the floor, Fae-da'Nar is a thousand different societies coexisting through restraint at the bottom.
