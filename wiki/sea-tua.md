---
title: Sea'tua
tags: [races, eadras, elfen, engineered-race, extinct]
...
**Summary**: The Sea'tua were the [[elfen|Elfen]]-engineered race created to oversee natural balance in the oceans — a relatively late Elfen project (created roughly **ten million years after the [[arathi-cataclysm|Arathi Cataclysm]]**, well after Eadras's hydrology had stabilized in its post-Drowning configuration) and the **common progenitor of all seven modern sapient sea peoples**: the **Five Modern Oceanic Races** ([[merrow|Merrow]], [[sirens|Sirens]], [[shimmercloaks|Shimmercloaks]], [[ink-lords|Ink Lords]], [[tideclad|Tideclad]]) and the two divergent alien-branch peoples ([[kuo-toa|Kuo-toa]], [[sahuagin|Sahuagin]]). The Sea'tua themselves no longer exist as a distinct people; their legacy survives entirely through their descendants.

**Sources**: Peoples of Eadras.txt; Updates afternoon 5-1-26.txt; Elfen.txt (cross-reference)
...
The Sea'tua are **not** Cataclysm survivors. Their creation horizon is well after the disaster, and they were purpose-built for the post-Drowning oceans, not for the original 70%-land world the Arathi had ruled.

## Purpose and role

The Sea'tua were created as **wardens of oceanic balance** — the marine analogue of the [[el-mer|El'mer]]'s land-warden function. Their charge was the same kind of patient ecological stewardship the Elfen exercised on the Prime Material's continents, scaled to the radically larger oceanic environment that emerged after the [[arathi-cataclysm|Cataclysm]] flooded most of the world. Specific Sea'tua practices and institutions are not directly documented in canon — what is preserved is the role definition and the descendant-pattern from which their original culture can be partially inferred.

## Inferred nature

Direct Sea'tua canon is thin; most of what can be said about them is **reconstructed from the shared traits of their descendants**.

The five modern Sea'tua-derived oceanic peoples — Merrow, Sirens, Shimmercloaks, Ink Lords, Tideclad — share a recognizable profile that almost certainly traces to their Sea'tua origin:

- **Visual kinship to the [[elfen|Elfen]]** — elongated, elegant body plans; clearly elven in proportion when seen in isolation. Surface dwellers historically lumped the five together as "[[merfolk|merfolk]]" largely on this visual basis.
- **Song-and-harmony magical traditions** — the Merrow's living architecture, the Sirens' geological reshaping, even the Ink Lords' chronicling all appear to descend from a shared Sea'tua aptitude for sustained harmonic working that mirrors the Elfen Song Magic from which the line descends.
- **Long, patient time-horizons** — multi-generational projects, slow trade negotiations, deep stewardship orientations. This is consistent with both the Elfen heritage and the original Sea'tua oceanic-warden charge.
- **Sapient competence as oceanic builders and ecological caretakers** rather than as warriors or hunters. Where the Sea'tua's siblings the El'mer were given more militarized purposes, the Sea'tua tradition is curatorial.

The two **alien-branch descendants** — [[kuo-toa|Kuo-toa]] and [[sahuagin|Sahuagin]] — diverged dramatically from the visible elven template. Kuo-toa drifted into Limina-haunted Gap-cult bodies and theology; Sahuagin into the submarine living war-fleets known to surface mariners as *islands that hunt*. Their divergence is so total that surface populations rarely associate them with the "merfolk" umbrella at all, and even informed scholars approach them as separate peoples whose Sea'tua origin is a genealogical fact rather than a cultural connection. That two such divergent lines emerged from a single progenitor stock is itself a piece of canon worth noting — the Sea'tua template was apparently capable of branching into both familiar and radically alien forms without breaking the underlying lineage.
...
The seven modern Sea'tua-descended peoples:
