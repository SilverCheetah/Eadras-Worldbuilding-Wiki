...
Shimmercloaks descend from the **Sea'tua**, the Elfen-engineered race created to oversee natural balance in the oceans. They are one of the five Sea'tua-descended modern oceanic peoples (source: Peoples of Eadras.txt; Updates afternoon 5-1-26.txt).

## Anatomy

Shimmercloaks have **long, sinuous, semi-translucent bodies with shifting iridescent patterns**. Their bodies are remarkably plastic: they can **flatten paper-thin** to slip through coral lattice or under doorframes, or **balloon into temporary trading halls** large enough to host a delegation of a dozen surface guests.

They peel off pieces of their own skin containing **perfect living memories and emotions** and exchange those pieces as currency. A Shimmercloak skin-coin is a one-time experience: the buyer absorbs the memory through contact with their own skin, lives it once, and the coin is spent. (source: Updates afternoon 5-1-26.txt)
