...
A Voroik-selected Windspeaker candidate is **leashed to a narrow path by fate** (source: Playground generation 3rd part.txt). Their strand is drawn taut before birth, while strands around them loosen. This concentration of fate-pressure is sometimes called the **Unasked Burden**: certain individuals must bear necessary constraints so that uncountable others may live freer lives.
...
A Windspeaker charter principle: *"The pole-bearer is not the pole. The thread-holder is not thread alone. Let the one fate-bound keep all freedoms fate has not taken."*
