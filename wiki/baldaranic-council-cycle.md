---
title: The Baldaranic Council Cycle
tags: [deities, eadras, modern-era]
aliases: [Baldaranic Council Cycle, Convocation of the Reopened Ledger]
...
The Cycle happens **during the First Rebrightening** because that era produces simultaneously:

- **Renewed mortal capacity** sufficient to repeat Arathi-pattern mistakes
- **Visible institutional failure** in the [[divine-bureaucracy|Bureaucracy's]] prayer-routing
- **Buried-history pressure** as the [[demon-war|Demon War]] passes into living-memory cutoff and the [[thousand-year-dimming|Thousand-Year Dimming's]] causes need explanation
...
**Principal outputs**:
- [[arathi|Arath]] reframed as warning rather than ladder
- Arathi "crystals" formally identified as [[arathi-geo-substrate|bio-engineered geo-substrate]]
- Pre-Cataclysm Eadras clarified as **non-tectonic**; modern plate tectonics identified as a post-Cataclysm condition
- [[deep-vaults|Deep Vault]] classification revised around substrate ethics and geological mismatch
- The [[vault-concordat|Vault Concordat]] negotiations initiated
...
The [[tome-of-baldaran|Tome of Baldaran]] is **not a passive archive** during the Cycle. The Tome:

- Curates which chapters the gods may consult during deliberation
- Records the Cycle's rulings with appropriate sealing
- Withholds material that the era cannot yet integrate
...
A standing cosmic decree sealed in the [[arathi-cataclysm|Cataclysm]] era binds the gods to silence on all categories of **unrecoverable cosmological ending**:

- Chaos-unmaking
- Demonic consumption ([[unreceived|the Unreceived]])
- Spirit-destruction
- Other forms of irrevocable loss
