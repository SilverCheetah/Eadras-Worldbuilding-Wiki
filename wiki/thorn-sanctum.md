...
At the **absolute heart of [[firethorn-hold|Firethorn Hold]]**, buried beneath layers of gray stone and matriarchal wards, lies the Thorn Sanctum (source: Grok WB Generation 4-29.txt).

It is **not a small meditation chamber**. It is a **massive domed hall**, vast enough to dwarf any mortal cathedral.
...
- **10 meters tall** and **8 meters wide**
- Forged from the **same leftover [[worldender-crystal|alien crystal]]** as the [[firethorn-throne|vanished Firethorn Throne]]
- **Floats slightly above the floor**, suspended by invisible resonance
- Its surface crawls with **living crystal thorns that twitch and realign like breathing lungs**
...
**Only eight women** may enter the Thorn Sanctum:

1. The **High Priestess-Mother**
2. The **Seven Thorn-Daughters**
...
When She speaks, the entire chamber **vibrates**. The thorns on the walls and Cauldron **bloom and retract in unison**.
...
- No [[magic-in-eadras|Weave]] disruption
- No demonic incursion
- No unauthorized scrying can pierce its boundaries

It is the **literal heart of the matriarchy's power**.

## Recording Function

The Cauldron is **both speaker and listener**. It **records every audience perfectly**, allowing the Mothers to replay Her commands centuries later with **flawless accuracy**.

This is one of the practical advantages of the matriarchy: doctrine never drifts. Every order from She is preserved exactly.

## Aftermath of an Audience
...
The High Priestess-Mother and the Seven Thorn-Daughters have **no idea** that:

1. The Cauldron contains a pocket dimension where their goddess physically lives
2. She is a **dragon**, not a divine ideal
...
> The Thorn Sanctum is the **chamber where the lie is given voice**. Faceless. Nameless. Unimaginably old.

> The 10-meter Cauldron of foreign fire burns at its center. Eight women kneel before it. A dragon listens from within, content that her perfect garden grows on schedule.

> And not one of those eight women has any idea what they are kneeling to.
