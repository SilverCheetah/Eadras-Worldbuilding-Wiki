...
The user's canonical present-day races list is explicit:
...
[[sylph|Sylph]], Elder Goddess of foolishness, indulgence, instinct, self-interest, and independence, is the **divine patron of all Fae** (source: More Info on the Elder Gods.txt). Her dominion over whim, pleasure, chaos, and unbridled freedom maps cleanly onto the Sidhe-descended fae temperament.

This makes the fae the only modern race with a clearly named divine patron from the Elder Gods themselves — the connection is intimate and pre-dates the Demon War. Sylph is also explicitly noted to have heavily influenced the **Purple dragon clan** in their early history (source: Dragons.txt), giving her a small but distinct patron-network across both fae and certain dragonkind.
...
Specific anatomical details of fae subtypes are not yet documented in canon. The chaos-infusion of the original Sidhe explains the wild variety in modern fae bodies — the same lineage produces pixies and dryads alike — but the exact branching is undefined.
