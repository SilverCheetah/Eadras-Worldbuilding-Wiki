...
Centaurs are **fae creatures** (source: user clarification 2026-04-30). Their lineage traces through the broader fae genealogy:

- The [[elfen|Elfen]] created the **Sidhe** to rule and regulate the [[feywild|Feywild]].
- The Sidhe were **infused with chaos during the [[chaos-crusades|First Chaos Crusade]]** (~600 million years ago), producing the [[fae|fae]] in all their varied modern forms.
- The chaos-infusion created two streams of fae: those that inhabit the Feywild and **those that live on the Prime**.

Centaurs are predominantly part of the **Prime-dwelling fae stream**, which is what makes them a familiar presence in mortal lands rather than an exotic Feywild visitation.

## Anatomy

Half-human, half-equine. Specific anatomical detail beyond the classic centaur body plan is not yet documented in canon.
