...
Snakefolk were created by [[dragons|dragons]] alongside the [[dragonfolk|Lizard People]] (kobolds, dragonborn, lizardfolk) in response to the appearance of the humanoid races (source: Dragons.txt, line 53; Peoples of Eadras.txt). They are direct draconic creations, not engineered by any of [[the-three|the Three]]'s progenitor races.

Snakefolk are listed as the **Snake People** branch of dragon-created races, sibling to the Lizard People branch but distinct in form (source: Dragons.txt).

## Yuan-ti Identification
...
Specific anatomical and cultural details for snakefolk remain to be defined. The Yuan-ti analogue suggests a hierarchy from more-human to more-serpent forms, organized around hidden cults and ritual ancestry, but no canon yet specifies how this manifests in Eadras.
...
As the only non-playable race in the dragon-created lineages, snakefolk are designated as adversary-stock for the modern setting: cultists, infiltrators, and serpent-cult enemies that PCs encounter rather than play. Their exclusion from playable status is a deliberate worldbuilding choice (source: Peoples of Eadras.txt).
