...
**Summary**: The umbrella category for all sapient races created by [[dragons|dragons]] in response to the proliferation of humanoid races. Dragonfolk includes the three Lizard People subtypes ([[kobolds|kobolds]], [[dragonborn|dragonborn]], [[lizardfolk|lizardfolk]]) and the Snake People ([[snakefolk|snakefolk]]), plus other anthropomorphic reptiles. Playable except for snakefolk.

**Sources**: Peoples of Eadras.txt, Dragons.txt
...
Per canon (source: Peoples of Eadras.txt, line 106 and 108):

> Dragon-Folk (Dragonborn, Kobold, Lizardfolk & Anthropomorphic Reptiles except Snakes)
>
> Snakefolk (NPC, Yuan-ti)

This means the **Lizard People** subtree is the playable face of the umbrella, with snakefolk explicitly carved out for NPC use:
...
## Why Snakefolk Are Carved Out

The user's worldbuilding decision to make snakefolk **NPC-only** is deliberate. They function as the Yuan-ti analogue for Eadras: cult-figures, schemers, and adversary-stock that PCs encounter rather than play (source: Peoples of Eadras.txt, line 108). Lizard People remain the playable expression of dragon-created sapience.
